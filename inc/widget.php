...
function sow_slider_register_scripts(){
	wp_register_style('sow-slider-slider', siteorigin_widget_get_plugin_dir_url('slider').'css/slider.css', array(), SOW_SLIDER_VERSION);
	wp_register_script('sow-slider-slider-cycle2', siteorigin_widget_get_plugin_dir_url('slider') . 'js/jquery.cycle.min.js', array('jquery'), SOW_SLIDER_VERSION);
	wp_register_script('sow-slider-slider-cycle2-swipe', siteorigin_widget_get_plugin_dir_url('slider') . 'js/jquery.cycle.swipe.min.js', array('jquery'), SOW_SLIDER_VERSION);
	wp_register_script('sow-slider-slider', siteorigin_widget_get_plugin_dir_url('slider') . 'js/slider.min.js', array('jquery'), SOW_SLIDER_VERSION);
}
